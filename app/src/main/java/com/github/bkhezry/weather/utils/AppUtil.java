...
public class AppUtil {
  ...
  public static String getWeatherStatus(int weatherCode, boolean isRTL) {
    if (weatherCode / 100 == 2) {
      ...
      } else if (MyApplication.localeManager.getLanguage().equals(LocaleManager.LANGUAGE_GERMAN)) {
        return Constants.WEATHER_STATUS_GERMAN[0];
      } else {
      ...
      if (isRTL) {
        ...
        return Constants.WEATHER_STATUS_GERMAN[1];
      } else {
      ...
      if (isRTL) {
        ...
        return Constants.WEATHER_STATUS_GERMAN[2];
      } else {
      ...
      if (isRTL) {
        ...
        return Constants.WEATHER_STATUS_GERMAN[3];
      } else {
      ...
      if (isRTL) {
        ...
        return Constants.WEATHER_STATUS_GERMAN[4];
      } else {
      ...
      if (isRTL) {
        ...
        return Constants.WEATHER_STATUS_GERMAN[5];
      } else {
      ...
      if (isRTL) {
        ...
        return Constants.WEATHER_STATUS_GERMAN[6];
      } else {
      ...
      if (isRTL) {
        ...
        return Constants.WEATHER_STATUS_GERMAN[7];
      } else {
      ...
      if (isRTL) {
        ...
        return Constants.WEATHER_STATUS_GERMAN[8];
      } else {
